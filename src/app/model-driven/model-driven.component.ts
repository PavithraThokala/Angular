...
export class ModelDrivenComponent {
  ...
  public userForm = new FormGroup({
      ...
      name : new FormControl('Pavithra', [Validators.required, Validators.minLength(4), Validators.maxLength(10)]),
      
      age : new FormControl(20, [Validators.required,Validators.min(0),  Validators.max(150)]),
